...
showWelcomeScene:function(){this.reset();sound.playTapMenuSound();cc.director.runScene(new WelcomeScene)}}),GameResultScene=cc.Scene.extend({onEnter:function(){this._super();var a=new GameResultLayer;this.addChild(a)}});cc.game.onStart=function(){cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(383,550,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.audioEngine.playMusic(res.music_ogg,!0);cc.director.runScene(new WelcomeScene)},this)};cc.game.run();
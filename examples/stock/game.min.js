...
p=c.BROWSER_TYPE_ANDROID:"trident"===p?p=c.BROWSER_TYPE_IE:"360 aphone"===p&&(p=c.BROWSER_TYPE_360)):n.indexOf("iphone")&&n.indexOf("mobile")&&(p="safari");c.browserType=p;p=n.match(/(iPad|iPhone|iPod)/i)?!0:!1;n=n.match(/android/i)||h.platform.match(/android/i)?!0:!1;r=c.OS_UNKNOWN;-1!==h.appVersion.indexOf("Win")?r=c.OS_WINDOWS:p?r=c.OS_IOS:-1!==h.appVersion.indexOf("Mac")?r=c.OS_OSX:-1!==h.appVersion.indexOf("X11")&&-1===h.appVersion.indexOf("Linux")?r=c.OS_UNIX:n?r=c.OS_ANDROID:-1!==h.appVersion.indexOf("Linux")&&
(r=c.OS_LINUX);c.os=r;c._supportMultipleAudio=-1<f.indexOf(c.browserType);var f=parseInt(a[b.renderMode]),n=cc._RENDER_TYPE_WEBGL,r=cc.newElement("Canvas"),s=cc._supportRender=!0,s=p?!window.WebGLRenderingContext||-1===e.indexOf(c.os):!window.WebGLRenderingContext||-1===d.indexOf(c.browserType)||-1===e.indexOf(c.os);if(1===f||0===f&&s||"file://"===location.origin)n=cc._RENDER_TYPE_CANVAS;c._canUseCanvasNewBlendModes=function(){var a=document.createElement("canvas");a.width=1;a.height=1;a=a.getContext("2d");
a.fillStyle="#000";a.fillRect(0,0,1,1);a.globalCompositeOperation="multiply";var b=document.createElement("canvas");b.width=1;b.height=1;var c=b.getContext("2d");c.fillStyle="#fff";c.fillRect(0,0,1,1);a.drawImage(b,0,0,1,1);return 0===a.getImageData(0,0,1,1).data[0]};c._supportCanvasNewBlendModes=c._canUseCanvasNewBlendModes();n!==cc._RENDER_TYPE_WEBGL||g.WebGLRenderingContext&&cc.create3DContext(r,{stencil:!0,preserveDrawingBuffer:!0})||(0===f?n=cc._RENDER_TYPE_CANVAS:cc._supportRender=!1);if(n===
cc._RENDER_TYPE_CANVAS)try{r.getContext("2d")}catch(u){cc._supportRender=!1}cc._renderType=n;try{c._supportWebAudio=!!(g.AudioContext||g.webkitAudioContext||g.mozAudioContext)}catch(t){c._supportWebAudio=!1}try{var v=c.localStorage=g.localStorage;v.setItem("storage","");v.removeItem("storage");v=null}catch(w){"SECURITY_ERR"!==w.name&&"QuotaExceededError"!==w.name||cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option"),c.localStorage=function(){}}d=c.capabilities=
...
t;a[12]=d;a[13]=m;a[14]=r;return this};a.kmMat4Multiply=function(a,b,c){var d=a.mat,k=b.mat,m=c.mat;c=k[0];b=k[1];var n=k[2],p=k[3],r=k[4],s=k[5],u=k[6],t=k[7],v=k[8],w=k[9],y=k[10],z=k[11],x=k[12],A=k[13],B=k[14],k=k[15],C=m[0],D=m[1],E=m[2],F=m[3],G=m[4],H=m[5],I=m[6],J=m[7],K=m[8],L=m[9],M=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=C*c+D*r+E*v+F*x;d[1]=C*b+D*s+E*w+F*A;d[2]=C*n+D*u+E*y+F*B;d[3]=C*p+D*t+E*z+F*k;d[4]=G*c+H*r+I*v+J*x;d[5]=G*b+H*s+I*w+J*A;d[6]=G*n+H*u+I*y+J*B;d[7]=G*p+H*t+I*
z+J*k;d[8]=K*c+L*r+M*v+N*x;d[9]=K*b+L*s+M*w+N*A;d[10]=K*n+L*u+M*y+N*B;d[11]=K*p+L*t+M*z+N*k;d[12]=O*c+P*r+Q*v+m*x;d[13]=O*b+P*s+Q*w+m*A;d[14]=O*n+P*u+Q*y+m*B;d[15]=O*p+P*t+Q*z+m*k;return a};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var d=b[1],k=b[2],m=b[3],n=b[4],p=b[5],r=b[6],s=b[7],u=b[8],t=b[9],v=b[10],w=b[11],y=b[12],z=b[13],x=b[14],A=b[15],B=c[0],C=c[1],D=c[2],E=c[3],F=c[4],G=c[5],H=c[6],I=c[7],J=c[8],K=c[9],L=c[10],M=c[11],N=c[12],O=c[13],P=c[14],c=c[15];b[0]=B*a+C*n+D*u+E*y;b[1]=
B*d+C*p+D*t+E*z;b[2]=B*k+C*r+D*v+E*x;b[3]=B*m+C*s+D*w+E*A;b[4]=F*a+G*n+H*u+I*y;b[5]=F*d+G*p+H*t+I*z;b[6]=F*k+G*r+H*v+I*x;b[7]=F*m+G*s+H*w+I*A;b[8]=J*a+K*n+L*u+M*y;b[9]=J*d+K*p+L*t+M*z;b[10]=J*k+K*r+L*v+M*x;b[11]=J*m+K*s+L*w+M*A;b[12]=N*a+O*n+P*u+c*y;b[13]=N*d+O*p+P*t+c*z;b[14]=N*k+O*r+P*v+c*x;b[15]=N*m+O*s+P*w+c*A;return this};a.getMat4MultiplyValue=function(a,b){var c=a.mat,d=b.mat,k=new Float32Array(16);k[0]=c[0]*d[0]+c[4]*d[1]+c[8]*d[2]+c[12]*d[3];k[1]=c[1]*d[0]+c[5]*d[1]+c[9]*d[2]+c[13]*d[3];
...
n={r:n.r,g:n.g,b:n.b,a:a._displayedOpacity},p=a._itemWidth,r=0;r<d;r++){var s=c.charCodeAt(r)-a._mapStartChar.charCodeAt(0),u=s%a._itemsPerRow,t=0|s/a._itemsPerRow,v;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(u=(2*u*h+1)/(2*g),s=u+(2*h-2)/(2*g),t=(2*t*k+1)/(2*f),v=t+(2*k-2)/(2*f)):(u=u*h/g,s=u+h/g,t=t*k/f,v=t+k/f);var w=m[r],y=w.tl,z=w.tr,x=w.bl,w=w.br;y.texCoords.u=u;y.texCoords.v=t;z.texCoords.u=s;z.texCoords.v=t;x.texCoords.u=u;x.texCoords.v=v;w.texCoords.u=s;w.texCoords.v=v;x.vertices.x=r*p;x.vertices.y=
0;x.vertices.z=0;w.vertices.x=r*p+p;w.vertices.y=0;w.vertices.z=0;y.vertices.x=r*p;y.vertices.y=a._itemHeight;y.vertices.z=0;z.vertices.x=r*p+p;z.vertices.y=a._itemHeight;z.vertices.z=0;y.colors=n;z.colors=n;x.colors=n;w.colors=n}0<d&&(e.dirty=!0,a=e.totalQuads,d>a&&e.increaseTotalQuadsWith(d-a))};a.setString=function(a){a=a.length;a>this._textureAtlas.totalQuads&&this._textureAtlas.resizeCapacity(a)};a._addChild=function(){}})();cc.LABEL_AUTOMATIC_WIDTH=-1;
...
f=c.rect();f.x=0;f.y=0;if(cc.rectContainsPoint(f,e))return c}return null}});_p=cc.Menu.prototype;cc.Menu.create=function(a){var b=arguments.length;0<b&&null==arguments[b-1]&&cc.log("parameters should not be ending with null in Javascript");return 0===b?new cc.Menu:1===b?new cc.Menu(a):new cc.Menu(Array.prototype.slice.call(arguments,0))};var res={background_gif:"res/background.gif",logo_png:"res/logo.png",resultBg_gif:"res/resultBg.gif",shareShow_png:"res/shareShow.png",widget_plist:"res/widget.plist",widget_png:"res/widget.png"},dataRes={data_js:"res/data/data.js",dataone_png:"res/data/dataone.png",datatwo_png:"res/data/datatwo.png"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var data=[];for(i in dataRes)data.push(dataRes[i]);var WelcomeLayer=cc.Layer.extend({LeftMan:null,RightMan:null,Logo:null,StartBtn:null,Background:null,ctor:function(){this._super();this.LeftMan=cc.Sprite.createWithSpriteFrameName("#leftMan.png");this.RightMan=cc.Sprite.createWithSpriteFrameName("#rightMan.png");this.Logo=new cc.Sprite(res.logo_png);var a=cc.Sprite.createWithSpriteFrameName("#startBtn_normal.png"),b=cc.Sprite.createWithSpriteFrameName("#startBtn_press.png"),c=cc.Sprite.createWithSpriteFrameName("#startBtn_normal.png");this.StartBtn=
new cc.MenuItemSprite(a,b,c,this.enterGame,this);this.Background=new cc.Sprite(res.background_gif);this.init()},init:function(){var a=cc.winSize;this.addChild(this.Background);this.Background.x=a.width/2;this.Background.y=a.height/2;this.LeftMan.x=120;this.LeftMan.y=a.height-260;this.LeftMan.scale=0.5;this.addChild(this.LeftMan);var b=cc.moveBy(1.2,cc.p(-30,30)).easing(cc.easeInOut(2)),b=cc.sequence(b,b.reverse()).repeatForever();this.LeftMan.runAction(b);this.RightMan.x=a.width/2+120;this.RightMan.y=
a.height/2+120;this.RightMan.scale=0.5;this.addChild(this.RightMan);b=cc.moveBy(1.2,cc.p(30,30)).easing(cc.easeInOut(2));b=cc.sequence(b,b.reverse()).repeatForever();this.RightMan.runAction(b);this.Logo.x=a.width/2;this.Logo.y=a.height/2;this.addChild(this.Logo);this.StartBtn.x=a.width/2;this.StartBtn.y=60;this.StartBtn.scale=0.5;a=new cc.Menu(this.StartBtn);this.addChild(a);a.x=0;a.y=0},enterGame:function(){cc.log("startGame");cc.LoaderScene.preload(data,function(){cc.director.runScene(new GameScene)},
this)}}),WelcomeScene=cc.Scene.extend({ctor:function(){this._super();cc.spriteFrameCache.addSpriteFrames(res.widget_plist);var a=new WelcomeLayer;this.addChild(a)}});var CLIPWIDTH=482,CLIPHEIGHT=346,GameLayer=cc.Layer.extend({Timer:null,CountDown:10,CorrectCount:0,Menu:null,RiseBtn:null,FallBtn:null,BoxBg:null,Data:null,KDiagram:null,ScreenClipper:null,Unit:0,DataLen:0,Step:9,Answer:"right",AnswerTitle:null,ResultLayer:null,ctor:function(){this._super();this.init()},init:function(){var a=cc.winSize,b=new cc.LayerColor(cc.color(56,130,187,255));b.setContentSize(a.width,a.height);this.addChild(b);this.BoxBg=cc.Sprite.createWithSpriteFrameName("#boxBg.png");this.BoxBg.x=
a.width/2;this.BoxBg.y=a.height/2;this.addChild(this.BoxBg);var b=cc.Sprite.createWithSpriteFrameName("#riseBtn_normal.png"),c=cc.Sprite.createWithSpriteFrameName("#riseBtn_press.png"),d=cc.Sprite.createWithSpriteFrameName("#riseBtn_normal.png");this.RiseBtn=new cc.MenuItemSprite(b,c,d,this.toCheckRise,this);b=cc.Sprite.createWithSpriteFrameName("#fallBtn_normal.png");c=cc.Sprite.createWithSpriteFrameName("#fallBtn_press.png");d=cc.Sprite.createWithSpriteFrameName("#fallBtn_normal.png");this.FallBtn=
new cc.MenuItemSprite(b,c,d,this.toCheckFall,this);this.RiseBtn.x=180;this.RiseBtn.y=275;this.FallBtn.x=a.width-180;this.FallBtn.y=275;this.Menu=new cc.Menu(this.RiseBtn,this.FallBtn);this.Menu.x=this.Menu.y=0;this.addChild(this.Menu);this.setKlineDiagram();this.drawShape();this.setClipper();this.ScreenClipper.addChild(this.KDiagram)},setKlineDiagram:function(){var a=[],b=0,b=0,c;for(c in KData)a.push(KData[c]);c=Math.round(Math.random()*(a.length-1));cc.log(c);this.Data=a[c];this.KDiagram=new cc.Sprite(data[c+
1]);this.DataLen=this.Data.length;b=this.KDiagram.getContentSize().width;console.log(b);this.Unit=b/this.DataLen;cc.log(this.Unit);b=11*this.Unit;this.KDiagram.x=b+4},toCheckRise:function(){1==this.Data[this.DataLen-1-this.Step]?(this.CorrectCount++,this.Answer="right"):this.Answer="wrong";this.showDiagram();this.showAnswerTitle()},toCheckFall:function(){0==this.Data[this.DataLen-1-this.Step]?(this.CorrectCount++,this.Answer="right"):this.Answer="wrong";this.showDiagram();this.showAnswerTitle()},
showAnswerTitle:function(){this.RiseBtn.setEnabled(!1);this.FallBtn.setEnabled(!1);this.AnswerTitle=cc.Sprite.createWithSpriteFrameName("#"+this.Answer+"_title.png");this.AnswerTitle.opacity=0;this.addChild(this.AnswerTitle);this.AnswerTitle.x=cc.winSize.width/2;this.AnswerTitle.y=436;var a=cc.fadeIn(0.5),b=cc.callFunc(this.callBack,this);this.AnswerTitle.runAction(cc.sequence(a,a.reverse(),b))},callBack:function(){this.removeChild(this.AnswerTitle);"wrong"==this.Answer||0==this.Step?(this.removeChild(this.Menu),
this.showResult()):(this.RiseBtn.setEnabled(!0),this.FallBtn.setEnabled(!0),this.Step--)},showDiagram:function(){var a=cc.moveBy(0.5,cc.p(-this.Unit,0));this.KDiagram.runAction(a)},showResult:function(){var a=cc.winSize;this.ResultLayer=new ResultLayer;this.ResultLayer.y=-a.height;this.addChild(this.ResultLayer);this.ResultLayer.runAction(cc.moveTo(0.5,cc.p(0,0)));this.ResultLayer.showResultContent(this.CorrectCount)},setClipper:function(){var a=cc.winSize;this.ScreenClipper=new cc.ClippingNode;var b=
this.drawShape();this.ScreenClipper.setStencil(b);this.ScreenClipper.x=a.width/2;this.ScreenClipper.y=a.height-351;this.ScreenClipper.setContentSize(CLIPWIDTH,CLIPHEIGHT);this.addChild(this.ScreenClipper)},drawShape:function(){var a=new cc.DrawNode;a.anchorX=a.anchorY=0.5;var b=cc.color(0,0,0,255);a.drawRect(cc.p(0,0),cc.p(482,346),b,1,b);a.setContentSize(CLIPWIDTH,CLIPHEIGHT);return a}}),ResultLayer=cc.Layer.extend({ResultBg:null,AgainBtn:null,ShareBtn:null,ResultContent:null,ShareBg:null,ctor:function(){this._super();
this.init()},init:function(){var a=cc.winSize;this.ResultBg=new cc.Sprite(res.resultBg_gif);var b=cc.Sprite.createWithSpriteFrameName("#againBtn_normal.png"),c=cc.Sprite.createWithSpriteFrameName("#againBtn_press.png"),d=cc.Sprite.createWithSpriteFrameName("#againBtn_normal.png");this.AgainBtn=new cc.MenuItemSprite(b,c,d,this.playAgain,this);b=cc.Sprite.createWithSpriteFrameName("#shareBtn_normal.png");c=cc.Sprite.createWithSpriteFrameName("#shareBtn_press.png");d=cc.Sprite.createWithSpriteFrameName("#shareBtn_normal.png");
this.ShareBtn=new cc.MenuItemSprite(b,c,d,this.shareToWeixin,this);this.ResultBg.x=a.width/2;this.ResultBg.y=a.height/2;this.addChild(this.ResultBg);b=new cc.Menu(this.AgainBtn,this.ShareBtn);this.AgainBtn.x=160;this.AgainBtn.y=120;this.ShareBtn.x=a.width-160;this.ShareBtn.y=120;this.addChild(b);b.x=b.y=0},showResultContent:function(a){var b=0,c=cc.winSize,b=0==a?0.1:(10*(a-0.6*Math.random())).toFixed(2);a=new cc.LabelTTF("\u4f60\u8fde\u7eed\u731c\u5bf9"+a+"\u6b21","Arial",32);b=new cc.LabelTTF("\u51fb\u8d25\u4e86"+
b+"%\u7684\u5c0f\u4f19\u4f34\u4eec\uff01","Arial",32);a.x=c.width/2;a.y=516;b.x=c.width/2;b.y=456;this.addChild(a);this.addChild(b)},playAgain:function(){cc.director.runScene(new WelcomeScene)},shareToWeixin:function(){var a=this;this.ShareBg=new cc.Sprite(res.shareShow_png);this.addChild(this.ShareBg);this.ShareBg.x=cc.winSize.width/2;this.ShareBg.y=cc.winSize.height/2;var b=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(){a.removeChild(a.ShareBg);
cc.eventManager.removeListener(b,a.ShareBg);return!0}});cc.eventManager.addListener(b,this.ShareBg)}}),GameScene=cc.Scene.extend({ctor:function(){this._super();var a=new GameLayer;this.addChild(a)}});cc.game.onStart=function(){cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(640,1136,cc.ResolutionPolicy.EXACT_FIT);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new WelcomeScene)},this)};cc.game.run();
...
cc.kmMat4Multiply=function(a,b,c){var d=a.mat,e=b.mat[0],f=b.mat[1],g=b.mat[2],h=b.mat[3],k=b.mat[4],m=b.mat[5],n=b.mat[6],p=b.mat[7],r=b.mat[8],q=b.mat[9],t=b.mat[10],s=b.mat[11],u=b.mat[12],v=b.mat[13],w=b.mat[14];b=b.mat[15];var x=c.mat[0],y=c.mat[1],z=c.mat[2],A=c.mat[3],B=c.mat[4],C=c.mat[5],D=c.mat[6],E=c.mat[7],F=c.mat[8],G=c.mat[9],H=c.mat[10],I=c.mat[11],J=c.mat[12],K=c.mat[13],L=c.mat[14];c=c.mat[15];d[0]=x*e+y*k+z*r+A*u;d[1]=x*f+y*m+z*q+A*v;d[2]=x*g+y*n+z*t+A*w;d[3]=x*h+y*p+z*s+A*b;d[4]=
B*e+C*k+D*r+E*u;d[5]=B*f+C*m+D*q+E*v;d[6]=B*g+C*n+D*t+E*w;d[7]=B*h+C*p+D*s+E*b;d[8]=F*e+G*k+H*r+I*u;d[9]=F*f+G*m+H*q+I*v;d[10]=F*g+G*n+H*t+I*w;d[11]=F*h+G*p+H*s+I*b;d[12]=J*e+K*k+L*r+c*u;d[13]=J*f+K*m+L*q+c*v;d[14]=J*g+K*n+L*t+c*w;d[15]=J*h+K*p+L*s+c*b;return a};
...
a.stencilOp(this._currentStencilFail,this._currentStencilPassDepthFail,this._currentStencilPassDepthPass);a.stencilMask(this._currentStencilWriteMask);this._currentStencilEnabled||a.disable(a.STENCIL_TEST);cc.ClippingNode.WebGLRenderCmd._layer--}})();cc.ACTION_TAG_INVALID=-1;
...
n={r:n.r,g:n.g,b:n.b,a:a._displayedOpacity},p=a._itemWidth,r=0;r<d;r++){var q=c.charCodeAt(r)-a._mapStartChar.charCodeAt(0),t=q%a._itemsPerRow,s=0|q/a._itemsPerRow,u;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(t=(2*t*h+1)/(2*g),q=t+(2*h-2)/(2*g),s=(2*s*k+1)/(2*f),u=s+(2*k-2)/(2*f)):(t=t*h/g,q=t+h/g,s=s*k/f,u=s+k/f);var v=m[r],w=v.tl,x=v.tr,y=v.bl,v=v.br;w.texCoords.u=t;w.texCoords.v=s;x.texCoords.u=q;x.texCoords.v=s;y.texCoords.u=t;y.texCoords.v=u;v.texCoords.u=q;v.texCoords.v=u;y.vertices.x=r*p;y.vertices.y=
0;y.vertices.z=0;v.vertices.x=r*p+p;v.vertices.y=0;v.vertices.z=0;w.vertices.x=r*p;w.vertices.y=a._itemHeight;w.vertices.z=0;x.vertices.x=r*p+p;x.vertices.y=a._itemHeight;x.vertices.z=0;w.colors=n;x.colors=n;y.colors=n;v.colors=n}0<d&&(e.dirty=!0,a=e.totalQuads,d>a&&e.increaseTotalQuadsWith(d-a))};a.setString=function(a){a=a.length;a>this._textureAtlas.totalQuads&&this._textureAtlas.resizeCapacity(a)};a._addChild=function(){}})();cc.LABEL_AUTOMATIC_WIDTH=-1;
...
f=c.rect();f.x=0;f.y=0;if(cc.rectContainsPoint(f,e))return c}return null}});_p=cc.Menu.prototype;cc.Menu.create=function(a){var b=arguments.length;0<b&&null==arguments[b-1]&&cc.log("parameters should not be ending with null in Javascript");return 0==b?new cc.Menu:1==b?new cc.Menu(a):new cc.Menu(Array.prototype.slice.call(arguments,0))};var res={background_gif:"res/background.jpg",logo_png:"res/logo.png",resultBg_gif:"res/resultBg.jpg",shareShow_png:"res/shareShow.jpg",widget_plist:"res/widget.plist",widget_png:"res/widget.png"},dataRes={data_js:"res/data/data.js",dataone_png:"res/data/dataone.png",datatwo_png:"res/data/datatwo.png"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var data=[];for(i in dataRes)data.push(dataRes[i]);var WelcomeLayer=cc.Layer.extend({LeftMan:null,RightMan:null,Logo:null,StartBtn:null,Background:null,ctor:function(){this._super();this.RightMan=cc.Sprite.createWithSpriteFrameName("#rightMan.png");this.Logo=new cc.Sprite(res.logo_png);var a=cc.Sprite.createWithSpriteFrameName("#startBtn_normal.png"),b=cc.Sprite.createWithSpriteFrameName("#startBtn_press.png"),c=cc.Sprite.createWithSpriteFrameName("#startBtn_normal.png");this.StartBtn=new cc.MenuItemSprite(a,b,c,this.enterGame,this);this.Background=
new cc.Sprite(res.background_gif);this.init()},init:function(){var a=cc.winSize;this.addChild(this.Background);this.Background.x=a.width/2;this.Background.y=a.height/2;this.RightMan.x=a.width/2+140;this.RightMan.y=a.height/2+160;this.RightMan.scale=0.5;this.addChild(this.RightMan);var b=cc.moveBy(1.2,cc.p(30,30)).easing(cc.easeInOut(2)),b=cc.sequence(b,b.reverse()).repeatForever();this.RightMan.runAction(b);this.Logo.x=a.width/2;this.Logo.y=a.height/2;this.addChild(this.Logo);this.StartBtn.x=a.width/
2;this.StartBtn.y=42;this.StartBtn.scale=0.5;a=new cc.Menu(this.StartBtn);this.addChild(a);a.x=0;a.y=0},enterGame:function(){cc.log("startGame");cc.LoaderScene.preload(data,function(){cc.director.runScene(new GameScene)},this)}}),WelcomeScene=cc.Scene.extend({ctor:function(){this._super();cc.spriteFrameCache.addSpriteFrames(res.widget_plist);var a=new WelcomeLayer;this.addChild(a)}});var CLIPWIDTH=482,CLIPHEIGHT=346,ResultText=[{percentage:"0%",text:"\u8fd8\u662f\u544a\u8bc9\u670b\u53cb\u51c6\u5907\u9000\u5e02\u5427\uff01"},{percentage:"50%",text:"\u65b0\u624b\u5427\uff0c\u8d76\u7d27\u53bb\u670b\u53cb\u5708\u70ab\u70ab\u5272\u4e86\u591a\u5c11\u8089\u5427\uff1f"},{percentage:"75%",text:"\u628a\u5c0f\u6563\u8eab\u4efd\u900f\u9732\u7ed9\u670b\u53cb\u5982\u4f55\uff1f"},{percentage:"87.5%",text:"\u770b\u6765\u6709\u70b9\u6c34\u5e73\uff0c\u8d76\u7d27\u53bb\u670b\u53cb\u5708\u70ab\u70ab\u5427\u3002"},
{percentage:"93.75%",text:"\u76f8\u5f53\u6709\u6c34\u51c6\uff0c\u8fd8\u4e0d\u5feb\u53bb\u670b\u53cb\u5708\u70ab\u5bcc?"},{percentage:"96.95%",text:"\u64cd\u76d8\u624b\u5427\uff0c\u8d76\u7d27\u544a\u8bc9\u5c0f\u4f19\u4f34\u4eec\u53bb\uff01"},{percentage:"98.5%",text:"\u79bb\u80a1\u795e\u4e5f\u5c31\u90a3\u4e48\u4e00\u70b9\u4e86\uff0c\u8d76\u7d27\u544a\u8bc9\u5c0f\u4f19\u4f34 \u4eec\u5427\uff01"},{percentage:"99.3%",text:"\u88ab\u5c01\u4e3a\u65b0\u4e00\u4ee3\u80a1\u795e\uff0c\u8fd8\u6709\u8c01\u6562\u6311\u6218\u6211\uff01"},
{percentage:"99.6%",text:"\u88ab\u5c01\u4e3a\u65b0\u4e00\u4ee3\u80a1\u795e\uff0c\u8fd8\u6709\u8c01\u6562\u6311\u6218\u6211\uff01"},{percentage:"99.6%",text:"\u88ab\u5c01\u4e3a\u65b0\u4e00\u4ee3\u80a1\u795e\uff0c\u8fd8\u6709\u8c01\u6562\u6311\u6218\u6211\uff01"},{percentage:"100%",text:"\u606d\u559c\u4f60\u73a9\u7206\u6240\u6709\u5e84\u5bb6\uff0c\u6b64\u65f6\u4e0d\u70ab\u66f4\u5f85\u4f55\u65f6\uff1f"}],GameLayer=cc.Layer.extend({Timer:null,CountDown:10,CorrectCount:0,Menu:null,RiseBtn:null,FallBtn:null,
BoxBg:null,Data:null,KDiagram:null,ScreenClipper:null,Unit:0,DataLen:0,Step:9,Answer:"right",AnswerTitle:null,ResultLayer:null,ctor:function(){this._super();this.init()},init:function(){var a=cc.winSize,b=new cc.LayerColor(cc.color(56,130,187,255));b.setContentSize(a.width,a.height);this.addChild(b);this.BoxBg=cc.Sprite.createWithSpriteFrameName("#boxBg.jpg");this.BoxBg.x=a.width/2;this.BoxBg.y=a.height/2;this.addChild(this.BoxBg);var b=cc.Sprite.createWithSpriteFrameName("#riseBtn_normal.png"),c=
cc.Sprite.createWithSpriteFrameName("#riseBtn_press.png"),d=cc.Sprite.createWithSpriteFrameName("#riseBtn_normal.png");this.RiseBtn=new cc.MenuItemSprite(b,c,d,this.toCheckRise,this);b=cc.Sprite.createWithSpriteFrameName("#fallBtn_normal.png");c=cc.Sprite.createWithSpriteFrameName("#fallBtn_press.png");d=cc.Sprite.createWithSpriteFrameName("#fallBtn_normal.png");this.FallBtn=new cc.MenuItemSprite(b,c,d,this.toCheckFall,this);this.RiseBtn.x=140;this.RiseBtn.y=150;this.FallBtn.x=a.width-140;this.FallBtn.y=
150;this.Menu=new cc.Menu(this.RiseBtn,this.FallBtn);this.Menu.x=this.Menu.y=0;this.addChild(this.Menu);this.setKlineDiagram();this.drawShape();this.setClipper();this.ScreenClipper.addChild(this.KDiagram)},setKlineDiagram:function(){var a=[],b=0,b=0,c;for(c in KData)a.push(KData[c]);c=Math.round(Math.random()*(a.length-1));this.Data=a[c];this.KDiagram=new cc.Sprite(data[c+1]);this.DataLen=this.Data.length;b=this.KDiagram.getContentSize().width;this.Unit=b/this.DataLen;b=11*this.Unit;this.KDiagram.x=
b+4},toCheckRise:function(){1==this.Data[this.DataLen-1-this.Step]?(this.CorrectCount++,this.Answer="right"):this.Answer="wrong";this.showDiagram();this.showAnswerTitle()},toCheckFall:function(){0==this.Data[this.DataLen-1-this.Step]?(this.CorrectCount++,this.Answer="right"):this.Answer="wrong";this.showDiagram();this.showAnswerTitle()},showAnswerTitle:function(){this.RiseBtn.setEnabled(!1);this.FallBtn.setEnabled(!1);this.AnswerTitle=cc.Sprite.createWithSpriteFrameName("#"+this.Answer+"_title.png");
this.AnswerTitle.opacity=0;this.addChild(this.AnswerTitle);this.AnswerTitle.x=cc.winSize.width/2;this.AnswerTitle.y=436;var a=cc.fadeIn(0.5),b=cc.callFunc(this.callBack,this);this.AnswerTitle.runAction(cc.sequence(a,a.reverse(),b))},callBack:function(){this.removeChild(this.AnswerTitle);"wrong"==this.Answer||0==this.Step?(this.removeChild(this.Menu),this.showResult()):(this.RiseBtn.setEnabled(!0),this.FallBtn.setEnabled(!0),this.Step--)},showDiagram:function(){var a=cc.moveBy(0.5,cc.p(-this.Unit,
0));this.KDiagram.runAction(a)},showResult:function(){var a=cc.winSize;this.ResultLayer=new ResultLayer;this.ResultLayer.y=-a.height;this.addChild(this.ResultLayer);this.ResultLayer.runAction(cc.moveTo(0.5,cc.p(0,0)));this.ResultLayer.showResultContent(this.CorrectCount)},setClipper:function(){var a=cc.winSize;this.ScreenClipper=new cc.ClippingNode;var b=this.drawShape();this.ScreenClipper.setStencil(b);this.ScreenClipper.x=a.width/2;this.ScreenClipper.y=a.height-351;this.ScreenClipper.setContentSize(CLIPWIDTH,
CLIPHEIGHT);this.addChild(this.ScreenClipper)},drawShape:function(){var a=new cc.DrawNode;a.anchorX=a.anchorY=0.5;var b=cc.color(0,0,0,255);a.drawRect(cc.p(0,0),cc.p(482,346),b,1,b);a.setContentSize(CLIPWIDTH,CLIPHEIGHT);return a}}),ResultLayer=cc.Layer.extend({ResultBg:null,AgainBtn:null,ShareBtn:null,ResultContent:null,ShareBg:null,ctor:function(){this._super();this.init()},init:function(){var a=cc.winSize;this.ResultBg=new cc.Sprite(res.resultBg_gif);var b=cc.Sprite.createWithSpriteFrameName("#againBtn_normal.png"),
c=cc.Sprite.createWithSpriteFrameName("#againBtn_press.png"),d=cc.Sprite.createWithSpriteFrameName("#againBtn_normal.png");this.AgainBtn=new cc.MenuItemSprite(b,c,d,this.playAgain,this);b=cc.Sprite.createWithSpriteFrameName("#shareBtn_normal.png");c=cc.Sprite.createWithSpriteFrameName("#shareBtn_press.png");d=cc.Sprite.createWithSpriteFrameName("#shareBtn_normal.png");this.ShareBtn=new cc.MenuItemSprite(b,c,d,this.shareToWeixin,this);this.ShareBtn.scaleY=1.16;this.ResultBg.x=a.width/2;this.ResultBg.y=
a.height/2;this.addChild(this.ResultBg);b=new cc.Menu(this.AgainBtn,this.ShareBtn);this.AgainBtn.x=160;this.AgainBtn.y=240;this.ShareBtn.x=a.width-160;this.ShareBtn.y=240;this.addChild(b);b.x=b.y=0},showResultContent:function(a){cc.log(a);var b=cc.winSize;if(10>a){var c=new cc.LabelTTF("\u4f60\u5728\u201c\u70b9\u70b9\u80a1\u795e\u4e89\u9738\u5927\u8d5b\u201d\u4e2d\u8fde\u7eed\u731c\u5bf9"+a+"\u6b21","Arial",23),d=new cc.LabelTTF("\u51fb\u8d25\u4e86"+ResultText[a].percentage+"\u7684\u80a1\u6c11\uff01",
"Arial",23),e=new cc.LabelTTF(ResultText[a].text,"Arial",23);c.x=b.width/2;c.y=b.height/2;d.x=b.width/2;d.y=526;e.x=b.width/2;e.y=484;this.addChild(c);this.addChild(d);this.addChild(e)}else 10==a&&(e=new cc.LabelTTF(ResultText[a].text,"Arial",24),cc.log(ResultText[a].text),e.x=b.width/2,e.y=b.height/2,this.addChild(e),cc.log(e))},playAgain:function(){cc.director.runScene(new WelcomeScene)},shareToWeixin:function(){var a=this;this.ShareBg=new cc.Sprite(res.shareShow_png);this.addChild(this.ShareBg);
this.ShareBg.x=cc.winSize.width/2;this.ShareBg.y=cc.winSize.height/2;var b=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(){a.removeChild(a.ShareBg);cc.eventManager.removeListener(b,a.ShareBg);return!0}});cc.eventManager.addListener(b,this.ShareBg)}}),GameScene=cc.Scene.extend({ctor:function(){this._super();var a=new GameLayer;this.addChild(a)}});cc.game.onStart=function(){cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(640,1136,cc.ResolutionPolicy.EXACT_FIT);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new WelcomeScene)},this)};cc.game.run();